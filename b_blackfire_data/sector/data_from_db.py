...
def set_sector_data(x):
    ...
    for level in level_naics:
        ...
        for naics_infos in sector_infos_db_.find():
            ...
            zone_query = {'naics': {"$regex": "^" + naics}, 'eco zone': zone_eco}
            stocks_in_zone = stocks_infos_db.find(zone_query)  # stocks list for naics
            ...
            for date in generate_month('1984M1', '2018M12'):
                ...
                if value is not None:
                    ...
                    to_insert = {'_id': naics, 'stocks': price_dict, 'price_target': pt_dict, 'consensus': cs_dict}
    ...
    for per in range(1, len(tab_date)):
        ...
        for sec in mysec:
            ...
            if mysec_p is not None:
                price_ac = sec['stocks']['price']
                price_pr = mysec_p['stocks']['price']
            ...
            sec['stocks']['ret'] = ret
            sector_db_ac.update_one({'_id': naics}, {'$set': {'stocks', sec['stocks']}})
